...
class Audio_Player{
    constructor(){
        ...
        this.names_radio = []
        this.names_radio[0]="Radio ClassRoom"
        this.names_radio[1]="Radio AMVClassRoom"
        this.names_radio[2]="Radio Win"
        this.source_audio = []
        this.source_audio[0] = "ClassRoom Of The Elite AMV House of Memories.mp3"
        this.source_audio[1] = "nofriends.mp3"
        this.source_audio[2] = "sound_win.mp3"
        this.server = 0
        this.setRessouce()
